...
public final class StringUtil {
    ...
    public static String replaceDftChkNullVariable(String variableSql,
        ...
        while (matcher.find()) {
            ...
            if (null == keyValue) {
                throw new SystemException(UtilConstant.MODEL_CODE_UTIL, UtilErrorMessage.ERR_CODE_200033,
     ...
     */
    public static String charsetConvert(String conversion, String charset) throws SystemException {
        String returnStr = "";
        try {
            byte[] bytes = conversion.getBytes("ISO-8859-1");
            returnStr = new String(bytes, charset);
        } catch (UnsupportedEncodingException e) {
            throw new SystemException(UtilConstant.MODEL_CODE_UTIL, e, charset);
        }
        return returnStr;
    }
        ...
        for (int i = 0; i < lArray.length; i++) {
            try {
                ...
                throw new SystemException(UtilConstant.MODEL_CODE_UTIL,
                        UtilErrorMessage.DATA_FORMAT_200013, sArray[i], "String", "Long");
            }
        }
        return lArray;
    }
